...
def main():
    ...
    ap.add_argument("--out", default="multitrack_fadeheat.mp4")
    ...
    ap.add_argument("--fade", type=float, default=0.85, help="Heatmap fade factor (0–1, smaller = faster fade)")
    args = ap.parse_args()
